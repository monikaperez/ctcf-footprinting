...
#SBATCH --output=/mmfs1/gscratch/stergachislab/mwperez/logs/merge_moka_CTCF_100bp_rle_max-filt_%j.out
#SBATCH -t 5-0
#SBATCH -c 10
...
#----- CTCF L rle max (init: rle_max, pos filt rle_max >= 2) -----

# Merge mokapot res with fiberseq data
input_file="CTCF_rle_max-filt.mokapot.psms.txt"
pos_file="CTCF_m6a_fiberseq_L_100bp_positive-cleaned_100bp.txt"
neg_file="CTCF_m6a_fiberseq_L_100bp_small_5_negative-cleaned_100bp.txt"
file_root="rle_max-filt"
